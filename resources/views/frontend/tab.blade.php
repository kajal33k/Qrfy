            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex flex-wrap gap-4 mb-4">
                        <button id="frame"
                            class=" content-frame px-4 py-2 bg-gray-200 rounded-lg shadow-md hover:bg-gray-300 transition">Frame</button>
                        <button id="envelope"
                            class=" content-envelope px-4 py-2 bg-gray-200 rounded-lg shadow-md hover:bg-gray-300 transition">Shape</button>
                        <button id="logo"
                            class=" content-logo px-4 py-2 bg-gray-200 rounded-lg shadow-md hover:bg-gray-300 transition">Logo</button>
                        <button id="level"
                            class=" content-level px-4 py-2 bg-gray-200 rounded-lg shadow-md hover:bg-gray-300 transition">Level</button>
                    </div>

                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div class="flex flex-col items-center">
                            <div class=" frame w-16 h-16 border rounded-lg bg-gray-100">--</div>
                            <span class="mt-2 text-sm text-gray-600">No Frame</span>
                        </div>
                        <div class=" envelope flex flex-col items-center">
